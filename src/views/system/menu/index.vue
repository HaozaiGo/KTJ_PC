    ...
    >
      ...
      >
        ...
        <el-form-item
          ...
          prop="path"
          v-if="
            formData.data.menuType === 'M' || formData.data.menuType === 'C'
          "
        >
          <el-input
        ...
        <el-form-item
          ...
          prop="perms"
          v-if="
            formData.data.menuType === 'C' || formData.data.menuType === 'F'
          "
        >
          <el-input
            v-model="formData.data.perms"
            placeholder="输入权限字符"
            clearable
          />
        </el-form-item>
